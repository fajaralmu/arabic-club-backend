...
import com.fajar.arabicclub.controller.MvcAppController;
import com.fajar.arabicclub.controller.MvcPublicController;
...
public class NavigationMenu implements Serializable {
	...
	private static Collection<? extends NavigationMenu> memberMenus() {
		return extractMenus(MvcAppController.class, true);
	}
}
